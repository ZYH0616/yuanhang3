...
<body>
    ...
    <section class="services-grid">
        <!-- 卡片 1 -->
        <div class="service-card" onclick="tap('商务翻译功能')">
            <div class="icon-box"><i class="fa-solid fa-language"></i></div>
            <h4>商务翻译</h4>
            <p>专业母语级翻译团队，结合 AI 技术实现精准的合同、文案及商务谈判本地化。 </p>
            <div class="learn-more">了解更多 <i class="fa-solid fa-arrow-right-long"></i></div>
        </div>
        <!-- 卡片 2 -->
        <div class="service-card" onclick="tap('AI营销功能')">
            <div class="icon-box"><i class="fa-solid fa-robot"></i></div>
            <h4>AI 营销</h4>
            <p>基于大模型的全球社媒投放策略，自动化生成爆款素材，提升海外转化率。 </p>
            <div class="learn-more">了解更多 <i class="fa-solid fa-arrow-right-long"></i></div>
        </div>
        <!-- 卡片 3 -->
        <div class="service-card" onclick="tap('合规风控功能')">
            <div class="icon-box"><i class="fa-solid fa-shield-check"></i></div>
            <h4>合规风控</h4>
            <p>实时同步全球法律法规变动，为您的跨境支付、劳务及数据安全保驾护航。</p>
            <div class="learn-more">了解更多 <i class="fa-solid fa-arrow-right-long"></i></div>
        </div>
    </section>
